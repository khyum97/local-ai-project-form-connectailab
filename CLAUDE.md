...
| 버전 | 날짜 | 변경 내용 |
|------|------|-----------|
| 2.101.4 | 2026-06-13 | 가상 사무실 UI 내 "프로젝트" 탭 및 워크스페이스 관리(조회, 추가, 선택, 저장, 삭제) 기능 실제 구현 및 프론트엔드-백엔드 연동 |
| 2.101.3 | 2026-06-13 | 가상 사무실 내 활성 프로젝트 관리 기능(조회, 추가, 선택, 저장, 삭제) 및 web_init/pack_apply 템플릿 프로젝트 연동성 강화 (stdout 로깅 전환) |
| 2.101.2 | 2026-06-13 | 모든 개발 에이전트(frontend, backend, junior_dev)의 목표 카드 및 CEO 팩토리 프롬프트에 디버깅 및 컴파일 검증 행동 강제 구문 강화 |
